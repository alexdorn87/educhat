...
const pkgdef :Spk.PackageDefinition = (
	...
	manifest = (
		...
		appTitle = (defaultText = "Eduard_Chat"),
		...
		actions = [
			...
			( title = (defaultText = "New Eduard_Chat"),
				command = .myCommand
		...
		metadata = (
			icons = (
				appGrid = (svg = embed "Eduard_Chat-128.svg"),
				grain = (svg = embed "Eduard_Chat-24.svg"),
				market = (svg = embed "Eduard_Chat-150.svg"),
			),

			website = "https://Eduard_Chat",
			codeUrl = "https://github.com/RocketChat/Eduard_Chat",
			license = (openSource = mit),
			categories = [communications, productivity, office, social, developerTools],

			author = (
				contactEmail = "team@Eduard_Chat",
				pgpSignature = embed "pgp-signature",
				upstreamAuthor = "Eduard_Chat",
			),
