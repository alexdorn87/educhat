...
RocketChat.settings.addGroup 'General', ->
	...
	@add 'Site_Name', 'Eduard_Chat', { type: 'string', public: true }
...
RocketChat.settings.addGroup 'Push', ->
	...
	@add 'Push_gateway', 'https://Eduard_Chat', { type: 'string' }
...
RocketChat.settings.addGroup 'Layout', ->
	...
	@section 'Content', ->
		...
		@add 'Layout_Home_Body', 'Welcome to Eduard_Chat <br> Go to APP SETTINGS -> Layout to customize this intro.', { type: 'code', code: 'text/html', multiline: true, public: true }
		...
		@add 'Layout_Sidenav_Footer', '<img style="left: 10px; position: absolute;" src="/assets/edu_logo.png" />', { type: 'code', code: 'text/html', public: true, i18nDescription: 'Layout_Sidenav_Footer_description' }
