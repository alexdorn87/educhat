RocketChat.settings.addGroup 'WebRTC', ->
	...
	@add 'WebRTC_Servers', 'stun:stun.l.google.com:19302, stun:23.21.150.121, team%40Eduard_Chat:demo@turn:numb.viagenie.ca:3478', { type: 'string', group: 'WebRTC', public: true}
